...
CanvasArray[1].width=window.innerWidth;
CanvasArray[1].height=window.innerHeight;
...
*/
	...
	vertex3d.prototype = {
		...
		window.onresize = function() {
			camera.display.x = wX*window.innerWidth/fx;
			camera.display.y = wY*window.innerHeight/fy;
		};
		CanvasArray.push(canvas);
